// Modified from the Unity Standard Assets
...
public class CustomFirstPersonController : MonoBehaviour {
    ...
    [SerializeField]
    private CustomMouseLook m_MouseLook;
    [SerializeField]
    ...
    private void GetInput(out float speed) {
        // Read input
        float horizontal = m_Controller.GetAxis("MoveH");
        float vertical = m_Controller.GetAxis("MoveV");
